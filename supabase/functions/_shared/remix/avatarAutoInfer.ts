...
import { mapApproxAgeToVocab } from "./avatarAgeRange.ts";
import { inferGenderFromName } from "./genderFromName.ts";
import { detectCountryGroup, PHENOTYPE_DEFAULTS } from "./countryPhenotypes.ts";
