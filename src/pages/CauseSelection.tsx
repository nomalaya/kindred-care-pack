    ...
    <Layout>
      <div className="container mx-auto px-4 py-12">
        <div className="text-center mb-12">
          <h1 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Choose a cause</h1>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Every cause represents real people facing real challenges. Pick the one that speaks to you.
          </p>
        </div>
